...
public protocol Xmtp_Xmtpv4_PayerApi_PayerApiClientInterface: Sendable {
    ...
    @discardableResult
    func `getNodes`(request: Xmtp_Xmtpv4_PayerApi_GetNodesRequest, headers: Connect.Headers, completion: @escaping @Sendable (ResponseMessage<Xmtp_Xmtpv4_PayerApi_GetNodesResponse>) -> Void) -> Connect.Cancelable

    @available(iOS 13, *)
    func `getNodes`(request: Xmtp_Xmtpv4_PayerApi_GetNodesRequest, headers: Connect.Headers) async -> ResponseMessage<Xmtp_Xmtpv4_PayerApi_GetNodesResponse>
}
...
public final class Xmtp_Xmtpv4_PayerApi_PayerApiClient: Xmtp_Xmtpv4_PayerApi_PayerApiClientInterface, Sendable {
    ...
    @discardableResult
    public func `getNodes`(request: Xmtp_Xmtpv4_PayerApi_GetNodesRequest, headers: Connect.Headers = [:], completion: @escaping @Sendable (ResponseMessage<Xmtp_Xmtpv4_PayerApi_GetNodesResponse>) -> Void) -> Connect.Cancelable {
        return self.client.unary(path: "/xmtp.xmtpv4.payer_api.PayerApi/GetNodes", idempotencyLevel: .unknown, request: request, headers: headers, completion: completion)
    }

    @available(iOS 13, *)
    public func `getNodes`(request: Xmtp_Xmtpv4_PayerApi_GetNodesRequest, headers: Connect.Headers = [:]) async -> ResponseMessage<Xmtp_Xmtpv4_PayerApi_GetNodesResponse> {
        return await self.client.unary(path: "/xmtp.xmtpv4.payer_api.PayerApi/GetNodes", idempotencyLevel: .unknown, request: request, headers: headers)
    }
    ...
    public enum Metadata {
        public enum Methods {
            ...
            public static let getNodes = Connect.MethodSpec(name: "GetNodes", service: "xmtp.xmtpv4.payer_api.PayerApi", type: .unary)
        }
    }
}

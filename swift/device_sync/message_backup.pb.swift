...
public struct Xmtp_DeviceSync_MessageBackup_GroupMessageSave: Sendable {
  ...
  public var contentTypeSave: Xmtp_DeviceSync_MessageBackup_ContentTypeSave = .unspecified
  ...
  public var hasOriginatorID: Bool {self._originatorID != nil}
...
extension Xmtp_DeviceSync_MessageBackup_GroupMessageSave: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{3}group_id\0\u{3}decrypted_message_bytes\0\u{3}sent_at_ns\0\u{1}kind\0\u{3}sender_installation_id\0\u{3}sender_inbox_id\0\u{3}delivery_status\0\u{3}content_type_save\0\u{3}version_major\0\u{3}version_minor\0\u{3}authority_id\0\u{3}reference_id\0\u{3}sequence_id\0\u{3}originator_id\0\u{3}content_type\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 9: try { try decoder.decodeSingularEnumField(value: &self.contentTypeSave) }()
      ...
      case 16: try { try decoder.decodeSingularStringField(value: &self.contentType) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.contentTypeSave != .unspecified {
      try visitor.visitSingularEnumField(value: self.contentTypeSave, fieldNumber: 9)
    }
    ...
    if !self.contentType.isEmpty {
      try visitor.visitSingularStringField(value: self.contentType, fieldNumber: 16)
    }
  ...
  public static func ==(lhs: Xmtp_DeviceSync_MessageBackup_GroupMessageSave, rhs: Xmtp_DeviceSync_MessageBackup_GroupMessageSave) -> Bool {
    ...
    if lhs.contentTypeSave != rhs.contentTypeSave {return false}

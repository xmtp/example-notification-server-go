...
const file_message_contents_content_proto_rawDesc = "" +
	"\n" +
...
var (
	...
	file_message_contents_content_proto_rawDescData []byte
)

func file_message_contents_content_proto_rawDescGZIP() []byte {
	file_message_contents_content_proto_rawDescOnce.Do(func() {
		file_message_contents_content_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_message_contents_content_proto_rawDesc), len(file_message_contents_content_proto_rawDesc)))
	})

...
const file_message_contents_contact_proto_rawDesc = "" +
	"\n" +
...
var (
	...
	file_message_contents_contact_proto_rawDescData []byte
)

func file_message_contents_contact_proto_rawDescGZIP() []byte {
	file_message_contents_contact_proto_rawDescOnce.Do(func() {
		file_message_contents_contact_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_message_contents_contact_proto_rawDesc), len(file_message_contents_contact_proto_rawDesc)))
	})
...
func file_message_contents_contact_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_message_contents_contact_proto_rawDesc), len(file_message_contents_contact_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,

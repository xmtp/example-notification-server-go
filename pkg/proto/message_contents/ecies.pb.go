...
func (x *EciesMessage) GetV1() []byte {
	if x, ok := x.GetVersion().(*EciesMessage_V1); ok {
		return x.V1
	}
	return nil
}
...
var file_message_contents_ecies_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x42, 0xfd, 0x01, 0x0a, 0x33, 0x6f, 0x72, 0x67, 0x2e, 0x78, 0x6d, 0x74, 0x70, 0x2e,
	0x61, 0x6e, 0x64, 0x72, 0x6f, 0x69, 0x64, 0x2e, 0x6c, 0x69, 0x62, 0x72, 0x61, 0x72, 0x79, 0x2e,
	0x70, 0x75, 0x73, 0x68, 0x2e, 0x78, 0x6d, 0x74, 0x70, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x42, 0x0a, 0x45, 0x63, 0x69, 0x65,
...
var file_message_contents_ecies_proto_goTypes = []interface{}{
...
func file_message_contents_ecies_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_message_contents_ecies_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EciesMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_message_contents_ecies_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*EciesMessage_V1)(nil),
	}
	type x struct{}

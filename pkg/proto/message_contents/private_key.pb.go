...
const file_message_contents_private_key_proto_rawDesc = "" +
	"\n" +
...
func file_message_contents_private_key_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_message_contents_private_key_proto_rawDesc), len(file_message_contents_private_key_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,

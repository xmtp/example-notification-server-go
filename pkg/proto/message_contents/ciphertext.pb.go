...
var file_message_contents_ciphertext_proto_rawDesc = []byte{
	...
	0x72, 0x74, 0x65, 0x78, 0x74, 0x42, 0xe8, 0x01, 0x0a, 0x19, 0x63, 0x6f, 0x6d, 0x2e, 0x78, 0x6d,
	0x74, 0x70, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x65,
...
func file_message_contents_ciphertext_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_message_contents_ciphertext_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SignedEciesCiphertext); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_message_contents_ciphertext_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_message_contents_ciphertext_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SignedEciesCiphertext_Ecies); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache

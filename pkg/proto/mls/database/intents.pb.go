...
import (
	message_contents "github.com/xmtp/example-notification-server-go/pkg/proto/mls/message_contents"
...
func (x *PostCommitAction_Installation) GetWelcomeWrapperAlgorithm() message_contents.WelcomeWrapperAlgorithm {
	if x != nil {
...
const file_mls_database_intents_proto_rawDesc = "" +
	...
	"/org.xmtp.android.library.push.xmtp.mls.databaseB\fIntentsProtoP\x01ZEgithub.com/xmtp/example-notification-server-go/pkg/proto/mls/database\xa2\x02\x03XMD\xaa\x02\x11Xmtp.Mls.Database\xca\x02\x11Xmtp\\Mls\\Database\xe2\x02\x1dXmtp\\Mls\\Database\\GPBMetadata\xea\x02\x13Xmtp::Mls::Databaseb\x06proto3"
